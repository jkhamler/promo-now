...
<div class="tab-pane fade" id="timedDraw" role="tabpanel"
     aria-labelledby="timed-draw-tab">

    <div class="container"><h2>Timed Draw Details - {{ $mechanic->promotion->name }}</h2></div>
