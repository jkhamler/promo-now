...
<div class="tab-pane fade" id="everybodyGets" role="tabpanel"
     aria-labelledby="everybody-gets-tab">

    <div class="container"><h2>Everybody Gets Details - {{ $mechanic->promotion->name }}</h2></div>
