...
<div class="tab-pane fade" id="mechanicItems" role="tabpanel"
     aria-labelledby="mechanic-items-tab">

    <div class="container"><h2>Prize Items - {{ $mechanic->promotion->name }}</h2></div>
